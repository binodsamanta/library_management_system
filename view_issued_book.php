    ...
    <div class="row">
        ...
        <form>
                <table class="table-bordered" width="900px" style="text-align: center">
                    ...
                    <?php
                    $sql="SELECT t1.book_no as book_no, t1.book_name as book_name, t1.book_author as book_author, t2.name as stu_name,t1.issue_date as issue_date
                    FROM issued_books as t1
                    LEFT JOIN users as t2
                    ON t1.student_id = t2.id
                    where t1.student_id=$row[id]";
