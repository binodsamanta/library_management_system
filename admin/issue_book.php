    ...
    <div class="col-md-4"></div>
        <div class="col-md-4">
            <form action="" method="post">
                ...
                <button class="btn btn-primary" type="submit" name="submit">Issue Book</button>
            </form>
        </div>
        <div class="col-md-4"></div>
    </div>
...
if(isset($_POST['submit'])){
    ...
    $sql="insert into issued_books(book_no,book_name,book_author,student_id,issue_date) values('$book_no','$book_name','$book_author','$student_id','$issue_date')";
    $res=mysqli_query($con,$sql);
    if($res){
        ?>
        <script>
