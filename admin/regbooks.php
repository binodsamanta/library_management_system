        ...
        <div class="col-md-8">
            <form>
                <table class="table-bordered" width="900px" style="text-align: center">
                    ...
                    <?php
                    $sql="SELECT books.book_name as book_name, authors.author_name as author_name, category.cat_name as cat_name, books.book_no as book_no, books.book_price as book_price
                    FROM books
