        ...
        <div class="col-md-8">
            <form>
                <table class="table-bordered" width="900px" style="text-align: center">
                    ...
                    <?php
                    $sql="SELECT t1.book_no as book_no, t1.book_name as book_name, t1.book_author as book_author, t2.name as stu_name,t1.issue_date as issue_date, t2.id as stuid
                    FROM issued_books as t1
                    ...
                    while($row=mysqli_fetch_assoc($res)){
                        ...
                        <td><button class="btn " name=""><a href="unissue_book.php?stu_id='.$row['stuid'].'" >unissue</a></button></td>
                        </tr>';
                    }
                    ?>
                </table>
