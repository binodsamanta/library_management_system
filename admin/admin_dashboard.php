            ...
            <div class="col-md-3 my-3">
                <div class="card bg-light" >
                    ...
                    <div class="card-body">
                        ...
                        <a href="regbooks.php" class="btn btn-success" target="_blank">View Registered books</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 my-3">
                <div class="card bg-light" >
                    ...
                    <div class="card-body">
                        ...
                        <a href="regcat.php" class="btn btn-success" target="_blank">View Categories</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 my-3">
                <div class="card bg-light" >
                    ...
                    <div class="card-body">
                        ...
                        <a href="regauthor.php" class="btn btn-success" target="_blank">View Authors</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 my-3">
