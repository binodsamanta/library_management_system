            ...
            <table class="table table-bordered table-hover">
                ...
                $res=mysqli_query($con,$sql);
                    while($row=mysqli_fetch_assoc($res)){
                        ...
                        <td>'.$row['cat_name'].'</td> 
                        <td>
                        <button class="btn " name=""><a href="edit_category.php?cat_id='.$row['cat_id'].'" >Edit</a></button>
                        <button class="btn " name=""><a href="delete_category.php?cat_id='.$row['cat_id'].'" >Delete</a></button>
                        </td>
                        </tr>'; 
                    }
                ?>
