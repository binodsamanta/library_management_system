            ...
            <table class="table table-bordered table-hover">
                ...
                $res=mysqli_query($con,$sql);
                    while($row=mysqli_fetch_assoc($res)){
                        ...
                        <td>
                        <button class="btn " name=""><a href="edit_author.php? author_id='.$row['author_id'].'" >Edit</a></button>
                        <button class="btn " name=""><a href="delete_author.php? author_id='.$row['author_id'].'" >Delete</a></button>
                        </td>
                        </tr>'; 
                    }
                ?>
