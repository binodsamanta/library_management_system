            ...
            <table class="table table-bordered table-hover">
                ...
                $res=mysqli_query($con,$sql);
                    while($row=mysqli_fetch_assoc($res)){
                        ...
                        <td>
                        <button class="btn " name=""><a href="edit_book.php?book_id='.$row['book_id'].'" >Edit</a></button>
                        <button class="btn " name=""><a href="delete_book.php?book_id='.$row['book_id'].'" >Delete</a></button>
                        </td>
                        </tr>'; 
                    }
                ?>
